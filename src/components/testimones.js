...
//         infinite: true,
//         speed: 500,
//         slidesToShow: 1, // Show one slide at a time on mobile/tablet
//         slidesToScroll: 1,
//         responsive: [
//             {
//                 breakpoint: 1024,
//                 settings: {
//                     slidesToShow: 2, // Show two slides for larger tablets or small desktops
//                 }
//             },
//             {
//                 breakpoint: 600,
//                 settings: {
//                     slidesToShow: 1, // Show one slide for mobile devices
//                 }
//             }
//         ]
//     };
...
//   useEffect(() => {
//     // Move to the next testimonial every second (1000ms)
...
//                 <div
//                   className="p-4 lg:w-1/2 w-full flex-shrink-0"
//                   key={index}
//                   style={{ width: '100%' }} // Each slide should take 100% of the width
//                 >
//                   <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
//                     <img
...
//                     />
//                     <div className="flex-grow sm:pl-8">
//                       <h2 className="title-font font-medium text-lg text-gray-900">{testimonial.name}</h2>
//                       <h3 className="text-gray-500 mb-3">{testimonial.role}</h3>
...
export default function About() {
    const testimonials = [
        { name: "Harshit Katheria", testimonial: "Developer", title: "All rounder" , imgUrl : "https://avatars.githubusercontent.com/u/55049998?v=4"},
